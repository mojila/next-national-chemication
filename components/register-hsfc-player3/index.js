...
class RegisterHSFCPlayer3 extends React.Component {
    state = {
        loading: true,
        saving: false,
        name: '',
    ...
    componentDidMount() {
        ...
        if (this.mounted) {
            ...
            databaseRef.child('player3Exist').once('value')
            .then(player3Exist => {
                if (player3Exist.val()) {
                    databaseRef.child('player3').once('value')
                    .then(player3 => this.setState({
                        name: player3.val().name,
                        birthPlace: player3.val().birthPlace,
                        birthDate: player3.val().birthDate,
                        backNumber: player3.val().backNumber,
                        contact: player3.val().contact,
                        photo: player3.val().photo,
                        studentCard: player3.val().studentCard,
                        reportCard: player3.val().reportCard,
                        loading: false
                    }))
                } else {
    ...
    onSubmit(e) {
        ...
        databaseRef.child('player3').update({
        ...
        .then(() => router.push('/register/hsfc/player4'))
    ...
    onPhotoUpload(e) {
        ...
        let uid = localStorage.getItem('hsfc-uid')
        let databaseRef = database.ref('pesertaHSFC/'+uid).child('player3')
        let storageRef = storage.ref('pesertaHSFC/'+uid).child('player3').child('photo').child(file.name)
    ...
    onStudentCardUpload(e) {
        ...
        let uid = localStorage.getItem('hsfc-uid')
        let databaseRef = database.ref('pesertaHSFC/'+uid).child('player3')
        let storageRef = storage.ref('pesertaHSFC/'+uid).child('player3').child('studentCard').child(file.name)
    ...
    onReportCardUpload(e) {
        ...
        let uid = localStorage.getItem('hsfc-uid')
        let databaseRef = database.ref('pesertaHSFC/'+uid).child('player3')
        let storageRef = storage.ref('pesertaHSFC/'+uid).child('player3').child('reportCard').child(file.name)
    ...
    render() {
        ...
        return (
            <div>
                <Container className="pt-md-5 pt-sm-3">
                    <RegisterHSFCTab active={3}/>
                    <RegisterHSFCPlayerTab active={3}/>
                        ...
                        <Row>
                            <Col md="6">
                                ...
                                <div className="p-1 small text-center text-white border bg-success rounded">
                                    ...
                                    { photoSaving && <center><ReactLoading width={33} height={33} color="white" type="spin"/></center> }
                            ...
                            <Col md="6">
                                ...
                                <div className="p-1 small text-center text-white border bg-success rounded">
                                    ...
                                    { studentCardSaving && <center><ReactLoading width={33} height={33} color="white" type="spin"/></center> }
                        ...
                        <Row>
                            ...
                            <Col md="6">
                                <div className="p-1 small text-center text-white border bg-success rounded mt-md-4">
                                    ...
                                    { reportCardSaving && <center><ReactLoading width={33} height={33} color="white" type="spin"/></center> }
                    ...
                    <div className="p-3 bg-light rounded border mb-5">
                        <Row>
                            <Col md="6" sm="6" xs="6">
                                <Button type="reset" color="outline-secondary" size="sm" onClick={() => router.push('/register/hsfc/player2')}>Kembali</Button>
                            </Col>
                            <Col md="6" sm="6" xs="6">
...
export default withRouter(RegisterHSFCPlayer3)